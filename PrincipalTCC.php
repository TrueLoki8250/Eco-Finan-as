...
<body class="w3-light-grey">
    <header>
        <img src="img/logo.jpeg" alt="Logo" class="w3-image w3-display-topmiddle" width="10%">
    </header>
    <div class= "barra_lateral">
        <nav class="w3-sidebar w3-bar-block w3-center w3-green" id="sidebar">
            ...
            <a href="#robjetivo" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-hover-text-green w3-text-light-grey">
    ...
    <header class="w3-container w3-padding-32 w3-center " id="inicio">
        <h1>
        <img src="img/controleSemFundo.png" alt="Logo" class="w3-image" width="20%">
            </br>
        </h1>
        <br>
    ...
    <div class=" w3-content w3-text-grey w3-card" id="ifinanceira">
    <h2 class="w3-text-green">Informações financeiras</h2>

        <div class="w3-row w3-section">
            <div class="w3-col" style="width:11%;" id="icones_dados_pessoais">
...
<!-- Obetivo -->
<div class="w3-padding-128 w3-content w3-text-grey" id="robjetivo">
